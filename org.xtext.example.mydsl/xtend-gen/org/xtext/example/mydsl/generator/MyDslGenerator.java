...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class ContextModel {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("private ArrayList<Entity> entities;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("private ArrayList<Relation> relations;");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public ContextModel() {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("entities = new ArrayList<>();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("relations = new ArrayList<>();");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public void addEntity(Entity entity) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public void addRelation(Relation relation) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("relations.add(relation);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public ArrayList<Entity> getEntities() {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public ArrayList<Relation> getRelations() {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return relations;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public boolean getExists() {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return exists;");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    fsa.generateFile("ContextModel.java", _builder);
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("import java.util.ArrayList;");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("public class ContextFragment {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private ArrayList<Entity> entities;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private ArrayList<Relation> relations;");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ContextFragment() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("entities = new ArrayList<>();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("relations = new ArrayList<>();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void addEntity(Entity entity) {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("entities.add(entity);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void addRelation(Relation relation) {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("relations.add(relation);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ArrayList<Entity> getEntities() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return entities;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ArrayList<Relation> getRelations() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return relations;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("}");
    _builder_1.newLine();
    fsa.generateFile("ContextFragment.java", _builder_1);
...
>>>>>>> [xTend] Added corresponding classes for new xText elements
    ...
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public Entity() {");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("name = \"name1\";");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("attributes = new ArrayList<>();");
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("}");
    _builder_2.newLine();
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public Entity(String name) {");
    _builder_2.newLine();
    _builder_2.append("        ");
    ...
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public String getName() {");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("return name;");
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("}");
    _builder_2.newLine();
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public ArrayList<Attribute> getAttributes() {");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("return attributes;");
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("}");
    _builder_2.newLine();
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public void addAttribute(Attribute attribute) {");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("attributes.add(attribute);");
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("}");
    _builder_2.newLine();
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public Attribute getAttributeByName(String name) {");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("Attribute result = new Attribute(\"not found\", \"0\");");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("for (Attribute a : attributes) {");
    _builder_2.newLine();
    _builder_2.append("            ");
    _builder_2.append("if (a.getName().equals(name)) {");
    _builder_2.newLine();
    _builder_2.append("                ");
    _builder_2.append("result = a;");
    _builder_2.newLine();
    _builder_2.append("            ");
    _builder_2.append("}");
    _builder_2.newLine();
    ...
    _builder_2.newLine();
    _builder_2.append("    ");
    _builder_2.append("public void setAttributeValueByName(String name, String value) {");
    _builder_2.newLine();
    _builder_2.append("        ");
    _builder_2.append("for (Attribute a : attributes) {");
    _builder_2.newLine();
    ...
    _builder_2.newLine();
    _builder_2.append("                ");
    _builder_2.append("a.setValue(value);");
    _builder_2.newLine();
    _builder_2.append("                ");
    ...
    _builder_2.append("}");
    _builder_2.newLine();
    fsa.generateFile("Entity.java", _builder_2);
    StringConcatenation _builder_3 = new StringConcatenation();
    _builder_3.append("public class Attribute {");
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("private String value;");
    _builder_3.newLine();
    _builder_3.append("    ");
    ...
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("public Attribute() {");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("name = \"name1\";");
    _builder_3.newLine();
    _builder_3.append("        ");
    ...
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("public Attribute(String name, String value) {");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("this.name = name;");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("this.value = value;");
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("}");
    _builder_3.newLine();
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("public String getValue() {");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("return value;");
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("}");
    _builder_3.newLine();
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("public String getName() {");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("return name;");
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("}");
    _builder_3.newLine();
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("public void setValue(String value) {");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("this.value = value;");
    _builder_3.newLine();
    ...
    _builder_3.newLine();
    _builder_3.append("    ");
    _builder_3.append("public void setName(String name) {");
    _builder_3.newLine();
    _builder_3.append("        ");
    _builder_3.append("this.name = name;");
    _builder_3.newLine();
    ...
    _builder_3.append("}");
    _builder_3.newLine();
    fsa.generateFile("Attribute.java", _builder_3);
    StringConcatenation _builder_4 = new StringConcatenation();
    _builder_4.append("import java.util.ArrayList;");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("public class Relation {");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("private Entity sender;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("private Entity receiver;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("private String name;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("private ArrayList<Attribute> attributes;");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public Relation() {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("sender = new Entity();");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("receiver = new Entity();");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("name = \"name1\";");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("attributes = new ArrayList<>();");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public Relation(String name, Entity sender, Entity receiver) {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.name = name;");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.sender = sender;");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.receiver = receiver;");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("attributes = new ArrayList<>();");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public void addAttribute(Attribute attribute) {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("attributes.add(attribute);");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public ArrayList<Attribute> getAttributes() {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("return attributes;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public Entity getReceiver() {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("return receiver;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public void setReceiver(Entity receiver) {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.receiver = receiver;");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public Entity getSender() {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("return sender;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public void setSender(Entity sender) {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("this.sender = sender;");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("public Attribute getAttributeByName(String name) {");
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("Attribute result = new Attribute(\"not found\", \"0\");");
    _builder_4.newLine();
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("for (Attribute a : attributes) {");
    _builder_4.newLine();
    _builder_4.append("            ");
    _builder_4.append("if (a.getName().equals(name)) {");
    _builder_4.newLine();
    _builder_4.append("                ");
    _builder_4.append("result = a;");
    _builder_4.newLine();
    _builder_4.append("            ");
    _builder_4.append("}");
    _builder_4.newLine();
    ...
    _builder_4.newLine();
    _builder_4.append("        ");
    _builder_4.append("return result;");
    _builder_4.newLine();
    _builder_4.append("    ");
    _builder_4.append("}");
    _builder_4.newLine();
    _builder_4.append("}");
    _builder_4.newLine();
    fsa.generateFile("Relation.java", _builder_4);
    StringConcatenation _builder_5 = new StringConcatenation();
    _builder_5.append("public class State {");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("private String id;");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("private StateType type;");
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public State() {");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("this.id = \"q0\";");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("this.type = StateType.NORMAL;");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("}");
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public State(String id, StateType stateType) {");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("this.id = id;");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("this.type = stateType;");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("}");
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public String getId() {");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("return id;");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("}");
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public StateType getType() {");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("return type;");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("}");
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public void setType(StateType type) {");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("this.type = type;");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("}");
    _builder_5.newLine();
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public void setId(String id) {");
    _builder_5.newLine();
    _builder_5.append("        ");
    _builder_5.append("this.id = id;");
    _builder_5.newLine();
    ...
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("public void writeState(){");
    _builder_5.newLine();
    _builder_5.append("    \t");
    _builder_5.append("System.out.println(this.id + \" \" + this.type);");
    _builder_5.newLine();
    _builder_5.append("    ");
    _builder_5.append("}");
    _builder_5.newLine();
    _builder_5.append("}");
    _builder_5.newLine();
    fsa.generateFile("State.java", _builder_5);
    StringConcatenation _builder_6 = new StringConcatenation();
    _builder_6.append("public enum StateType {");
    _builder_6.newLine();
    _builder_6.append("    ");
    _builder_6.append("NORMAL, ACCEPT, FINAL, ACCEPT_ALL");
    _builder_6.newLine();
    _builder_6.append("}");
    _builder_6.newLine();
    _builder_6.newLine();
    fsa.generateFile("StateType.java", _builder_6);
    StringConcatenation _builder_7 = new StringConcatenation();
    _builder_7.append("public class Transition {");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("private String id;");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("private State sender;");
    _builder_7.newLine();
    _builder_7.append("    ");
    ...
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public Transition(String id, State sender, State receiver) {");
    _builder_7.newLine();
    _builder_7.append("    \t");
    _builder_7.append("if(id.equals(\"1\")){");
    _builder_7.newLine();
    _builder_7.append("    \t\t");
    _builder_7.append("this.id = \"true\";");
    _builder_7.newLine();
    _builder_7.append("    \t");
    ...
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("this.sender = sender;");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("this.receiver = receiver;");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("}");
    _builder_7.newLine();
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public String getId() {");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("return id;");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("}");
    _builder_7.newLine();
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public State getSender() {");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("return sender;");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("}");
    _builder_7.newLine();
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public State getReceiver() {");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("return receiver;");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("}");
    _builder_7.newLine();
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public void setReceiver(State receiver) {");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("this.receiver = receiver;");
    _builder_7.newLine();
    ...
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public void setSender(State sender) {");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("this.sender = sender;");
    _builder_7.newLine();
    ...
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public void setId(String id) {");
    _builder_7.newLine();
    _builder_7.append("        ");
    _builder_7.append("if(id.equals(\"1\")){");
    _builder_7.newLine();
    ...
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("public void writeTransition(){");
    _builder_7.newLine();
    _builder_7.append("    \t");
    _builder_7.append("System.out.println(this.id + \" \" + this.sender.getId() + \"->\" + this.receiver.getId());");
    _builder_7.newLine();
    _builder_7.append("    ");
    _builder_7.append("}");
    _builder_7.newLine();
    _builder_7.append("}");
    _builder_7.newLine();
    fsa.generateFile("Transition.java", _builder_7);
    StringConcatenation _builder_8 = new StringConcatenation();
    _builder_8.append("import java.util.ArrayList;");
    _builder_8.newLine();
    _builder_8.newLine();
    _builder_8.append("public class Automaton {");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("private String id;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("private ArrayList<State> states;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("private ArrayList<Transition> transitions;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("private State initial;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("private State finale;");
    _builder_8.newLine();
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public Automaton(String id) {");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("this.id = id;");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("this.states = new ArrayList<>();");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("this.transitions = new ArrayList<>();");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public void setFinale(State state){");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("this.finale = state;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public State getFinale(){");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("return this.finale;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public void setInitial(State state){");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("this.initial = state;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public State getInitial(){");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("return this.initial;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}\t");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public ArrayList<State> getStates(){");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("return states;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public ArrayList<Transition> getTransitions(){");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("return transitions;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public String getId() {");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("return id;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public void setId(String id) {");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("this.id = id;");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public void addState(State newState){");
    _builder_8.newLine();
    _builder_8.append("        ");
    _builder_8.append("states.add(newState);");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public void rename(){");
    _builder_8.newLine();
    _builder_8.append("       ");
    _builder_8.append("int counter = 0;");
    _builder_8.newLine();
    _builder_8.append("       ");
    _builder_8.append("int _counter = 0;");
    _builder_8.newLine();
    _builder_8.append("       ");
    _builder_8.append("for(State s : this.states) {");
    _builder_8.newLine();
    _builder_8.append("       \t");
    _builder_8.append("if(s.getId().equals(\"qinit\") || s.getId().equals(\"qfinal\") || s.getId().equals(\"qaccepting\")){");
    _builder_8.newLine();
    _builder_8.append("       \t\t");
    _builder_8.append("s.setId(s.getId() + _counter);");
    _builder_8.newLine();
    _builder_8.append("       \t\t");
    _builder_8.append("_counter++;");
    _builder_8.newLine();
    _builder_8.append("       \t");
    _builder_8.append("}else{");
    _builder_8.newLine();
    _builder_8.append("         \t");
    _builder_8.append("s.setId(\"q\" + counter);");
    _builder_8.newLine();
    _builder_8.append("         \t");
    _builder_8.append("counter++;");
    _builder_8.newLine();
    _builder_8.append("         ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public ArrayList<Transition> findSender(State state){");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("ArrayList<Transition> senderTransitions = new ArrayList<Transition>();");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("for(Transition t : this.transitions){");
    _builder_8.newLine();
    _builder_8.append("    \t\t");
    _builder_8.append("if(t.getSender().getId().equals(state.getId()))");
    _builder_8.newLine();
    _builder_8.append("    \t\t\t");
    _builder_8.append("senderTransitions.add(t);");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("}\t");
    _builder_8.newLine();
    _builder_8.append("    \t");
    _builder_8.append("return senderTransitions;");
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public ArrayList<Transition> findReceiver(State state){");
    _builder_8.newLine();
    _builder_8.append("       ");
    _builder_8.append("ArrayList<Transition> receiverTransitions = new ArrayList<Transition>();");
    _builder_8.newLine();
    _builder_8.append("       ");
    _builder_8.append("for(Transition t : this.transitions){");
    _builder_8.newLine();
    _builder_8.append("       \t ");
    _builder_8.append("if(t.getReceiver().getId().equals(state.getId()))");
    _builder_8.newLine();
    _builder_8.append("            ");
    _builder_8.append("receiverTransitions.add(t);");
    _builder_8.newLine();
    _builder_8.append("         ");
    _builder_8.append("}");
    _builder_8.newLine();
    _builder_8.append("       ");
    _builder_8.append("return receiverTransitions;");
    _builder_8.newLine();
    _builder_8.append("     ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("    ");
    _builder_8.append("public void addTransition(Transition newTransition){");
    _builder_8.newLine();
    _builder_8.append("   \t\t");
    _builder_8.append("if(transitions.isEmpty()){");
    _builder_8.newLine();
    _builder_8.append("   \t\t\t");
    _builder_8.append("transitions.add(newTransition);");
    _builder_8.newLine();
    _builder_8.append("   \t\t    ");
    ...
    _builder_8.newLine();
    _builder_8.append("   \t\t");
    _builder_8.append("for(Transition t : transitions){");
    _builder_8.newLine();
    _builder_8.append("   \t\t\t");
    _builder_8.append("if(t.getId().equals(newTransition.getId()) ");
    _builder_8.newLine();
    _builder_8.append("   \t\t    \t");
    _builder_8.append("&& t.getSender().equals(newTransition.getSender()) ");
    _builder_8.newLine();
    _builder_8.append("   \t\t        ");
    _builder_8.append("&& t.getReceiver().equals(newTransition.getReceiver()))");
    _builder_8.newLine();
    _builder_8.append("   \t\t        \t");
    _builder_8.append("return;");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.append("public void collapse(Automaton automaton){");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("if(this.states.isEmpty() && this.transitions.isEmpty()){");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("for (State s : automaton.states)");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("this.addState(s);");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("for (Transition t : automaton.transitions)");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("this.addTransition(t);");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.initial = automaton.initial;");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.finale = automaton.finale;");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.newLine();
    _builder_8.append("           ");
    ...
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("ArrayList<Transition> receive = findReceiver(this.finale);");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("ArrayList<Transition> send = findSender(this.finale);");
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.newLine();
    _builder_8.append("               ");
    ...
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("for (Transition t : receive) ");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("t.setReceiver(automaton.initial);");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("for (Transition t : send) ");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("t.setSender(automaton.initial);");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.states.remove(finale);");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.finale = automaton.finale;");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.append("public void merge(ArrayList<Automaton> automatas){");
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("State qinit = new State(\"qinit\", StateType.NORMAL);");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("State qfinal = new State(\"qfinal\", StateType.FINAL);");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.newLine();
    _builder_8.append("           ");
    ...
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.initial = qinit;");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("}else{");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.addTransition(new Transition(\"epsilon\", this.finale, qinit));");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("this.addState(qinit);");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("this.addState(qfinal);");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("this.finale = qfinal;");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("State qaccepting = new State(\"qaccepting\", StateType.ACCEPT_ALL);");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("this.addState(qaccepting);");
    _builder_8.newLine();
    _builder_8.append("   ");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("for (Automaton a : automatas) {");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("for (Transition t : a.transitions)");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("this.addTransition(t);");
    _builder_8.newLine();
    ...
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("for (State s : a.states) {");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("this.addState(s);");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("if (s.getType().equals(StateType.FINAL))");
    _builder_8.newLine();
    _builder_8.append("                       ");
    _builder_8.append("this.addTransition(new Transition(\"epsilon\", s, qfinal));");
    _builder_8.newLine();
    _builder_8.append("                   ");
    _builder_8.append("if (s.getType().equals(StateType.ACCEPT_ALL))");
    _builder_8.newLine();
    _builder_8.append("                       ");
    _builder_8.append("this.addTransition(new Transition(\"epsilon\", s, qaccepting));");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("}");
    _builder_8.newLine();
    _builder_8.append("               ");
    _builder_8.append("this.addTransition(new Transition(\"epsilon\", qinit, a.initial));");
    _builder_8.newLine();
    _builder_8.append("           ");
    _builder_8.append("}");
    _builder_8.newLine();
    ...
    _builder_8.append("}");
    _builder_8.newLine();
    fsa.generateFile("Automaton.java", _builder_8);
  ...
  public CharSequence compile_appear_required(final AppearMessage am) {
    ...
    String _name = am.getEntity().getName();
    _builder.append(_name);
    _builder.append("\" + \")\", actualState, actualState));");
    _builder.newLineIfNotEmpty();
    _builder.append("newState = new State(\"q\" + counter, StateType.FINAL);");
  ...
  public CharSequence compile_changeto_required(final ChangeToMessage cm) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("String required_value = \"TODO\";");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"!\"+ \"changeTo(\" + \"TODO\" + \"(\" + required_value.substring(1, required_value.length() - 1) + \"))\", actualState, actualState));");
    _builder.newLine();
    _builder.append("newState = new State(\"q\" + counter, StateType.FINAL);");
    _builder.newLine();
    _builder.append("counter++;");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"TODO\" + \"(\" + required_value.substring(1, required_value.length() - 1) + \"))\", actualState, newState));");
    _builder.newLine();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.setFinale(newState);");
  ...
  public CharSequence compile_changeto_fail(final ChangeToMessage cm) {
    ...
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("String fail_value = \"TODO\";");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"1\", actualState, actualState));");
    _builder.newLine();
    _builder.append("newState = new State(\"q\" + counter, StateType.ACCEPT_ALL);");
    ...
    _builder.append("counter++;");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"TODO\" + \"(\" + fail_value.substring(1, fail_value.length() - 1) + \"))\" , actualState, newState));");
    _builder.newLine();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"1\", newState, newState));");
  ...
  public CharSequence compile_changeto_msg(final ChangeToMessage cm) {
    ...
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("String msg_value = \"TODO\";");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"1\", actualState, actualState));");
    _builder.newLine();
    _builder.append("newState = new State(\"q\" + counter, StateType.FINAL);");
    ...
    _builder.append("counter++;");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"TODO\" + \"(\" + msg_value.substring(1, msg_value.length() - 1) + \"))\" , actualState, newState));");
    _builder.newLine();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.setFinale(newState);");
  ...
  public CharSequence compile_changeto_strict_required(final ChangeToMessage cm) {
    ...
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("String strict_required_value = \"TODO\";");
    _builder.newLine();
    _builder.append("finalState = new State(\"q\" + counter, StateType.FINAL);");
    _builder.newLine();
    _builder.append("counter++;");
    ...
    _builder.append("counter++;");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"TODO\" + \"(\" + strict_required_value.substring(1, strict_required_value.length() - 1) + \"))\" , actualState, finalState));");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"!\" + \"changeTo(\" + \"TODO\" + \"(\" + strict_required_value.substring(1, strict_required_value.length() - 1) + \"))\" , actualState, acceptState));");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"1\", acceptState, acceptState));");
    _builder.newLine();
    _builder.append("b.addState(acceptState);");
  ...
  public CharSequence compile_changeto_strict_fail(final ChangeToMessage cm) {
    ...
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.newLine();
    _builder.append("String strict_fail_value = \"TODO\";");
    _builder.newLine();
    _builder.append("finalState = new State(\"q\" + counter, StateType.FINAL);");
    _builder.newLine();
    _builder.append("counter++;");
    ...
    _builder.append("counter++;");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"!\" + \"changeTo(\" + \"TODO\" + \"(\" + strict_fail_value.substring(1, strict_fail_value.length() - 1) + \"))\", actualState, finalState));");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"TODO\" + \"(\" + strict_fail_value.substring(1, strict_fail_value.length() - 1) + \"))\", actualState, acceptState));");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"1\", acceptState, acceptState));");
    _builder.newLine();
    _builder.append("b.addState(finalState);");
  ...
  public CharSequence compile_changeto_strict(final ChangeToMessage cm) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("String strict_value = \"TODO\";");
    _builder.newLine();
    _builder.append("newState = new State(\"q\" + counter, StateType.FINAL);");
    _builder.newLine();
    _builder.append("counter++;");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"TODO\" + \"(\" + strict_value.substring(1, strict_value.length() - 1) + \"))\", actualState, newState));");
    _builder.newLine();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.setFinale(newState);");
