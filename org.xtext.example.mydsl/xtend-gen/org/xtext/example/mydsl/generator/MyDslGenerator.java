...
>>>>>>> [xTend] Added corresponding classes for new xText elements
  ...
  public CharSequence compile_changeto_required(final ChangeToMessage cm) {
    ...
    _builder.append(_name);
    _builder.append("\" + \"(\" + required_value.substring(1, required_value.length() - 1) + \"))\", actualState, actualState));");
    _builder.newLineIfNotEmpty();
    _builder.append("newState = new State(\"q\" + counter, StateType.FINAL);");
    _builder.newLine();
    _builder.append("counter++;");
    ...
    _builder.append(_name_1);
    _builder.append("\" + \"(\" + required_value.substring(1, required_value.length() - 1) + \"))\", actualState, newState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.setFinale(newState);");
  ...
  public CharSequence compile_changeto_fail(final ChangeToMessage cm) {
    ...
    String _name = cm.getAttribute().getName();
    _builder.append(_name);
    _builder.append("\" + \"(\" + fail_value.substring(1, fail_value.length() - 1) + \"))\" , actualState, newState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.addTransition(new Transition(\"1\", newState, newState));");
  ...
  public CharSequence compile_changeto_msg(final ChangeToMessage cm) {
    ...
    String _name = cm.getAttribute().getName();
    _builder.append(_name);
    _builder.append("\" + \"(\" + msg_value.substring(1, msg_value.length() - 1) + \"))\" , actualState, newState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.setFinale(newState);");
  ...
  public CharSequence compile_changeto_strict_required(final ChangeToMessage cm) {
    ...
    String _name = cm.getAttribute().getName();
    _builder.append(_name);
    _builder.append("\" + \"(\" + strict_required_value.substring(1, strict_required_value.length() - 1) + \"))\" , actualState, finalState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addTransition(new Transition(\"!\" + \"changeTo(\" + \"");
    String _name_1 = cm.getAttribute().getName();
    _builder.append(_name_1);
    _builder.append("\" + \"(\" + strict_required_value.substring(1, strict_required_value.length() - 1) + \"))\" , actualState, acceptState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addTransition(new Transition(\"1\", acceptState, acceptState));");
    _builder.newLine();
    _builder.append("b.addState(acceptState);");
  ...
  public CharSequence compile_changeto_strict_fail(final ChangeToMessage cm) {
    ...
    String _name = cm.getAttribute().getName();
    _builder.append(_name);
    _builder.append("\" + \"(\" + strict_fail_value.substring(1, strict_fail_value.length() - 1) + \"))\", actualState, finalState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addTransition(new Transition(\"changeTo(\" + \"");
    String _name_1 = cm.getAttribute().getName();
    _builder.append(_name_1);
    _builder.append("\" + \"(\" + strict_fail_value.substring(1, strict_fail_value.length() - 1) + \"))\", actualState, acceptState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addTransition(new Transition(\"1\", acceptState, acceptState));");
    _builder.newLine();
    _builder.append("b.addState(finalState);");
  ...
  public CharSequence compile_changeto_strict(final ChangeToMessage cm) {
    ...
    String _name = cm.getAttribute().getName();
    _builder.append(_name);
    _builder.append("\" + \"(\" + strict_value.substring(1, strict_value.length() - 1) + \"))\", actualState, newState));");
    _builder.newLineIfNotEmpty();
    _builder.append("b.addState(newState);");
    _builder.newLine();
    _builder.append("b.setFinale(newState);");
