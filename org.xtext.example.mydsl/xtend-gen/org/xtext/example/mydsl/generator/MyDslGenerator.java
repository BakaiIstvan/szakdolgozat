...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public CharSequence compile_eventcreator(final Domain d) {
    ...
    _builder.newLine();
    {
      EList<ContextModel> _contextmodels = d.getContextmodels();
      for(final ContextModel m : _contextmodels) {
        _builder.append("\t");
        _builder.append("private ");
        String _firstUpper = StringExtensions.toFirstUpper(m.getName());
        _builder.append(_firstUpper, "\t");
        _builder.append(" ");
        String _firstLower = StringExtensions.toFirstLower(m.getName());
        _builder.append(_firstLower, "\t");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    {
      EList<ContextModel> _contextmodels_1 = d.getContextmodels();
      for(final ContextModel m_1 : _contextmodels_1) {
        _builder.append("\t\t");
        String _firstUpper_2 = StringExtensions.toFirstUpper(m_1.getName());
        _builder.append(_firstUpper_2, "\t\t");
        _builder.append(" ");
        String _firstLower_2 = StringExtensions.toFirstLower(m_1.getName());
        _builder.append(_firstLower_2, "\t\t");
        _builder.append(",");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    {
      EList<ContextModel> _contextmodels_2 = d.getContextmodels();
      for(final ContextModel m_2 : _contextmodels_2) {
        _builder.append("\t\t");
        _builder.append("this.");
        String _firstLower_4 = StringExtensions.toFirstLower(m_2.getName());
        _builder.append(_firstLower_4, "\t\t");
        _builder.append(" = ");
        String _firstLower_5 = StringExtensions.toFirstLower(m_2.getName());
        _builder.append(_firstLower_5, "\t\t");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    {
      EList<ContextModel> _contextmodels_3 = d.getContextmodels();
      for(final ContextModel m_3 : _contextmodels_3) {
        _builder.append("\t\t");
        _builder.append("monitorInterface.update(\"appear(");
        String _firstUpper_4 = StringExtensions.toFirstUpper(m_3.getName());
        _builder.append(_firstUpper_4, "\t\t");
          ...
          for(final ContextFragment f_3 : _contextfragments_3) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              for(final Integer e : _doubleDotLessThan) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _firstLower_9 = StringExtensions.toFirstLower(m_3.getName());
                _builder.append(_firstLower_9, "\t\t\t");
                _builder.append(".get");
            ...
            }
            {
              ...
              for(final Integer r : _doubleDotLessThan_1) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _firstLower_10 = StringExtensions.toFirstLower(m_3.getName());
                _builder.append(_firstLower_10, "\t\t\t");
                _builder.append(".get");
            ...
            String _firstUpper_7 = StringExtensions.toFirstUpper(m_3.getName());
            _builder.append(_firstUpper_7, "\t\t\t");
            _builder.append(", ");
    ...
    _builder.newLine();
    {
      EList<ContextModel> _contextmodels_4 = d.getContextmodels();
      for(final ContextModel m_4 : _contextmodels_4) {
        _builder.append("\t\t");
        _builder.append("monitorInterface.update(\"disappear(");
        String _firstUpper_9 = StringExtensions.toFirstUpper(m_4.getName());
        _builder.append(_firstUpper_9, "\t\t");
        _builder.append(".\" + name + \")\"); ");
        _builder.newLineIfNotEmpty();
        {
          ...
          for(final ContextFragment f_4 : _contextfragments_4) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              for(final Integer e_1 : _doubleDotLessThan_2) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _firstLower_12 = StringExtensions.toFirstLower(m_4.getName());
                _builder.append(_firstLower_12, "\t\t\t");
                _builder.append(".get");
            ...
            }
            {
              ...
              for(final Integer r_1 : _doubleDotLessThan_3) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _firstLower_13 = StringExtensions.toFirstLower(m_4.getName());
                _builder.append(_firstLower_13, "\t\t\t");
                _builder.append(".get");
            ...
            _builder.append("\t");
            _builder.append("monitorInterface.update(\"match(");
            String _firstUpper_12 = StringExtensions.toFirstUpper(m_4.getName());
            _builder.append(_firstUpper_12, "\t\t\t");
            _builder.append(", ");
    ...
    _builder.newLine();
    {
      EList<ContextModel> _contextmodels_5 = d.getContextmodels();
      for(final ContextModel m_5 : _contextmodels_5) {
        _builder.append("\t\t");
        _builder.append("monitorInterface.update(\"changeTo(");
        String _firstUpper_14 = StringExtensions.toFirstUpper(m_5.getName());
        _builder.append(_firstUpper_14, "\t\t");
          ...
          for(final ContextFragment f_5 : _contextfragments_5) {
            ...
            _builder.newLineIfNotEmpty();
            {
              ...
              for(final Integer e_2 : _doubleDotLessThan_4) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _firstLower_15 = StringExtensions.toFirstLower(m_5.getName());
                _builder.append(_firstLower_15, "\t\t\t");
                _builder.append(".get");
            ...
            }
            {
              ...
              for(final Integer r_2 : _doubleDotLessThan_5) {
                _builder.append("\t\t");
                _builder.append("\t");
                String _firstLower_16 = StringExtensions.toFirstLower(m_5.getName());
                _builder.append(_firstLower_16, "\t\t\t");
                _builder.append(".get");
            ...
            _builder.append("\t");
            _builder.append("monitorInterface.update(\"match(");
            String _firstUpper_17 = StringExtensions.toFirstUpper(m_5.getName());
            _builder.append(_firstUpper_17, "\t\t\t");
            _builder.append(", ");
