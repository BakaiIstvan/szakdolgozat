...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final Domain s) {
        ...
        _builder.newLine();
        {
          ...
          for(final ScenarioContent sc : _scenariocontents) {
              ...
              for(final Par p : _par) {
                ...
                _builder.newLine();
                {
                  ...
                  for(final ParExpression pe : _parexpression) {
                    ...
                    _builder.newLine();
                    {
                      EList<Message> _messages = pe.getMessages();
            ...
            }
            {
              ...
              for(final Message m_2 : _message) {
                {
                  ...
                  if (_isConstraint_2) {
                    ...
                    _builder.newLine();
                    {
                      EList<Message> _messages_4 = m_2.getC().getMessages();
                      for(final Message msg_2 : _messages_4) {
                        _builder.append("\t\t");
                        _builder.append("+ \"!\" + \"");
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("ArrayList<Transition> transitions = new ArrayList<Transition>();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("for(Automaton a : automatas){");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("for(Transition t : a.getTransitions()){");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("transitions.add(t);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("return permute(transitions, automatas);");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public ArrayList<Automaton> permute(ArrayList<Transition> transitions, ArrayList<Automaton> automatas) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("ArrayList<Automaton> result = new ArrayList<>();");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("permuteHelper(result, new ArrayList<>(), transitions, automatas);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("public void permuteHelper(ArrayList<Automaton> list, ArrayList<Transition> resultList, ArrayList<Transition> transitions, ArrayList<Automaton> automatas) {");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("if(resultList.size() == transitions.size()) {");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("Automaton newAutomata = new Automaton(\"id\");");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("for(Transition t : resultList) {");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("newAutomata.addTransition(t);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("}");
    _builder.newLine();
    _builder.newLine();
    _builder.append("            ");
    _builder.append("for(State s : automatas.get(0).getStates()){");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("newAutomata.addState(s);");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("newAutomata.setInitial(automatas.get(0).getInitial());");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("newAutomata.setFinale(automatas.get(0).getFinale());");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("list.add(newAutomata);");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("if(resultList.contains(transitions.get(i))) {");
    _builder.newLine();
    _builder.append("                    ");
    ...
    _builder.newLine();
    _builder.append("                ");
    _builder.append("resultList.add(transitions.get(i));");
    _builder.newLine();
    _builder.append("                ");
    _builder.append("permuteHelper(list, resultList, transitions, automatas);");
    _builder.newLine();
    _builder.append("                ");
