...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final Domain s) {
    ...
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("ArrayList<Automaton> result = new ArrayList<Automaton>();");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("Automaton temp = new Automaton(\"temp\");");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("permute(automatas, 0, automatas.size() - 1, result, temp);");
    _builder.newLine();
    _builder.append("\t        ");
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("public void permute(ArrayList<Automaton> automatas, int l, int r, ArrayList<Automaton> result, Automaton temp){");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("if(l == r)");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("{");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t                ");
    _builder.append("temp = new Automaton(\"temp\");");
    _builder.newLine();
    _builder.append("\t                ");
    _builder.append("temp.collapse(a);");
    _builder.newLine();
    _builder.append("\t            ");
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t            ");
    _builder.append("result.add(temp);");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("}else{");
    _builder.newLine();
    _builder.append("\t            ");
    _builder.append("for(int i = l; i <= r; i++){");
    _builder.newLine();
    _builder.append("\t                ");
    _builder.append("automatas = swap(automatas, l, i);");
    _builder.newLine();
    _builder.append("\t                ");
    _builder.append("permute(automatas, l + 1, r, result, temp);");
    _builder.newLine();
    _builder.append("\t                ");
    _builder.append("automatas = swap(automatas, l , i);");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("public ArrayList<Automaton> swap(ArrayList<Automaton> automatas, int i, int j){");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("Automaton temp;");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("temp = automatas.get(i);");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("automatas.set(i, automatas.get(j));");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("automatas.set(j, temp);");
    _builder.newLine();
    _builder.append("\t        ");
