...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    Iterable<Relation> _filter_1 = Iterables.<Relation>filter(IteratorExtensions.<EObject>toIterable(resource.getAllContents()), Relation.class);
    for (final Relation m_1 : _filter_1) {
    ...
    Iterable<Domain> _filter_2 = Iterables.<Domain>filter(IteratorExtensions.<EObject>toIterable(resource.getAllContents()), Domain.class);
    for (final Domain m_2 : _filter_2) {
      fsa.generateFile(
        "EventCreator.java", this.compile_eventcreator(m_2));
    }
