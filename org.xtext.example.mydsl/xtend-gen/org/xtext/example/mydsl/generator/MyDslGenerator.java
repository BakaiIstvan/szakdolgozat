...
public class MyDslGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource resource, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("public class Automaton {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private String id;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private ArrayList<State> states;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private ArrayList<Transition> transitions;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private State initial;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("private State finale;");
    _builder_1.newLine();
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public Automaton(String id) {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.id = id;");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.states = new ArrayList<>();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.transitions = new ArrayList<>();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void setFinale(State state){");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.finale = state;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public State getFinale(){");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return this.finale;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void setInitial(State state){");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("this.initial = state;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public State getInitial(){");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("return this.initial;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}\t");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ArrayList<State> getStates(){");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("return states;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ArrayList<Transition> getTransitions(){");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("return transitions;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void addState(State newState){");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("states.add(newState);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void rename(){");
    _builder_1.newLine();
    _builder_1.append("       ");
    _builder_1.append("int counter = 0;");
    _builder_1.newLine();
    _builder_1.append("       ");
    _builder_1.append("int _counter = 0;");
    _builder_1.newLine();
    _builder_1.append("       ");
    _builder_1.append("for(State s : this.states) {");
    _builder_1.newLine();
    _builder_1.append("       \t");
    _builder_1.append("if(s.getId().equals(\"qinit\") || s.getId().equals(\"qfinal\") || s.getId().equals(\"qaccepting\")){");
    _builder_1.newLine();
    _builder_1.append("       \t\t");
    _builder_1.append("s.setId(s.getId() + _counter);");
    _builder_1.newLine();
    _builder_1.append("       \t\t");
    _builder_1.append("_counter++;");
    _builder_1.newLine();
    _builder_1.append("       \t");
    _builder_1.append("}else{");
    _builder_1.newLine();
    _builder_1.append("         \t");
    _builder_1.append("s.setId(\"q\" + counter);");
    _builder_1.newLine();
    _builder_1.append("         \t");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ArrayList<Transition> findSender(State state){");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("ArrayList<Transition> senderTransitions = new ArrayList<Transition>();");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("for(Transition t : this.transitions){");
    _builder_1.newLine();
    _builder_1.append("    \t\t");
    _builder_1.append("if(t.getSender().getId().equals(state.getId()))");
    _builder_1.newLine();
    _builder_1.append("    \t\t\t");
    _builder_1.append("senderTransitions.add(t);");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("}\t");
    _builder_1.newLine();
    _builder_1.append("    \t");
    _builder_1.append("return senderTransitions;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public ArrayList<Transition> findReceiver(State state){");
    _builder_1.newLine();
    _builder_1.append("       ");
    _builder_1.append("ArrayList<Transition> receiverTransitions = new ArrayList<Transition>();");
    _builder_1.newLine();
    _builder_1.append("       ");
    _builder_1.append("for(Transition t : this.transitions){");
    _builder_1.newLine();
    _builder_1.append("       \t ");
    _builder_1.append("if(t.getReceiver().getId().equals(state.getId()))");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("receiverTransitions.add(t);");
    _builder_1.newLine();
    _builder_1.append("         ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("       ");
    _builder_1.append("return receiverTransitions;");
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public void addTransition(Transition newTransition){");
    _builder_1.newLine();
    _builder_1.append("   \t\t");
    _builder_1.append("if(transitions.isEmpty()){");
    _builder_1.newLine();
    _builder_1.append("   \t\t\t");
    _builder_1.append("transitions.add(newTransition);");
    _builder_1.newLine();
    _builder_1.append("   \t\t    ");
    ...
    _builder_1.newLine();
    _builder_1.append("   \t\t");
    _builder_1.append("for(Transition t : transitions){");
    _builder_1.newLine();
    _builder_1.append("   \t\t\t");
    _builder_1.append("if(t.getId().equals(newTransition.getId()) ");
    _builder_1.newLine();
    _builder_1.append("   \t\t    \t");
    _builder_1.append("&& t.getSender().equals(newTransition.getSender()) ");
    _builder_1.newLine();
    _builder_1.append("   \t\t        ");
    _builder_1.append("&& t.getReceiver().equals(newTransition.getReceiver()))");
    _builder_1.newLine();
    _builder_1.append("   \t\t        \t");
    _builder_1.append("return;");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.append("public void collapse(Automaton automaton){");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("if(this.states.isEmpty() && this.transitions.isEmpty()){");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("for (State s : automaton.states)");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("this.addState(s);");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("for (Transition t : automaton.transitions)");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("this.addTransition(t);");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.initial = automaton.initial;");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.finale = automaton.finale;");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.newLine();
    _builder_1.append("           ");
    ...
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("ArrayList<Transition> receive = findReceiver(this.finale);");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("ArrayList<Transition> send = findSender(this.finale);");
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.newLine();
    _builder_1.append("               ");
    ...
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("for (Transition t : receive) ");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("t.setReceiver(automaton.initial);");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("for (Transition t : send) ");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("t.setSender(automaton.initial);");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.states.remove(finale);");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.finale = automaton.finale;");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.append("public void merge(ArrayList<Automaton> automatas){");
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("State qinit = new State(\"qinit\", StateType.NORMAL);");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("State qfinal = new State(\"qfinal\", StateType.FINAL);");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.newLine();
    _builder_1.append("           ");
    ...
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.initial = qinit;");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("}else{");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.addTransition(new Transition(\"epsilon\", this.finale, qinit));");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("this.addState(qinit);");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("this.addState(qfinal);");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("this.finale = qfinal;");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("State qaccepting = new State(\"qaccepting\", StateType.ACCEPT_ALL);");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("this.addState(qaccepting);");
    _builder_1.newLine();
    _builder_1.append("   ");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("for (Automaton a : automatas) {");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("for (Transition t : a.transitions)");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("this.addTransition(t);");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("for (State s : a.states) {");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("this.addState(s);");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("if (s.getType().equals(StateType.FINAL))");
    _builder_1.newLine();
    _builder_1.append("                       ");
    _builder_1.append("this.addTransition(new Transition(\"epsilon\", s, qfinal));");
    _builder_1.newLine();
    _builder_1.append("                   ");
    _builder_1.append("if (s.getType().equals(StateType.ACCEPT_ALL))");
    _builder_1.newLine();
    _builder_1.append("                       ");
    _builder_1.append("this.addTransition(new Transition(\"epsilon\", s, qaccepting));");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("               ");
    _builder_1.append("this.addTransition(new Transition(\"epsilon\", qinit, a.initial));");
    _builder_1.newLine();
    _builder_1.append("           ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.append("}");
    _builder_1.newLine();
    fsa.generateFile("Automaton.java", _builder_1);
