...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMessageAccess().getResetinconstraintAssignment_19(), "rule__Message__ResetinconstraintAssignment_19");
			builder.put(grammarAccess.getMessageAccess().getClockconstraintAssignment_21(), "rule__Message__ClockconstraintAssignment_21");
			builder.put(grammarAccess.getMessageAccess().getCConstraintAssignment_23(), "rule__Message__CConstraintAssignment_23");
			builder.put(grammarAccess.getMessageAccess().getResetclockAssignment_25(), "rule__Message__ResetclockAssignment_25");
