...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getNameAccess().getGroup_0(), "rule__Name__Group_0__0");
			builder.put(grammarAccess.getNameAccess().getGroup_0_3(), "rule__Name__Group_0_3__0");
			...
			builder.put(grammarAccess.getNameAccess().getParamsAssignment_0_2(), "rule__Name__ParamsAssignment_0_2");
			builder.put(grammarAccess.getNameAccess().getParamsAssignment_0_3_1(), "rule__Name__ParamsAssignment_0_3_1");
